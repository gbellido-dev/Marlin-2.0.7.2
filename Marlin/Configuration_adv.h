...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PD0        // Set a custom pin for the controller fan
 ...
 */
#define E0_AUTO_FAN_PIN PD2
#define E1_AUTO_FAN_PIN PD5
...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS   310       // Set this to the distance between toolheads when both heads are homed
